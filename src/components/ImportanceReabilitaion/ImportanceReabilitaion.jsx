        ...
        <div className="importance__grid-container">
          ...
          <div className="importance__item-third">
            ...
            <p className="importance__item-third-text">
              Среди наших выпускников есть — отцы-одиночки, жены которых умерли
              или оказались в местах лишения свободы. Они были в шаге от лишения
              родительских прав, их дети — на пороге учреждений, занимающихся
              сиротами. Все это случилось бы, если бы мужчины не прошли
              реабилитацию. Сейчас их дети живут с родными отцами, которые
              научились заботиться, любить и радоваться без употребления
