        ...
        <div className="section-right">
          <div className="section-right__wrapper">
            ...
            <p className="top__text-your-help">
              <span className='green'> Ваша помощь может спасти жизни людей,</span> восстановить семьи и&nbsp;дать шанс
              на
              счастливую жизнь их&nbsp;детям, жизнь в&nbsp;полноценной семье. На&nbsp;сегодняшний день количество
              человек, которые
